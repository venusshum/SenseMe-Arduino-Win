/**
* \defgroup SenseMeAccelerometer Driver for SenseMe Accelerometer
* 
...
#ifndef __SENSEMEACCELEROMETER_H__
#define __SENSEMEACCELEROMETER_H__
...
class SenseMeAccelerometerClass 
{
	private:
		void activate();
		void standby();
...
extern SenseMeAccelerometerClass SenseMeAccelerometer;
