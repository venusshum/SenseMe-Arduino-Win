/**
* \addtogroup SenseMeAccelerometer
*
* This is the driver code for Accelerometer on the SenseMe
...
*/
SenseMeAccelerometerClass::SenseMeAccelerometerClass()
{
}
...
* 
*/
void SenseMeAccelerometerClass::begin() 
{	uint8_t reg;
...
*
*/
void SenseMeAccelerometerClass::end() 
{
	standby();		// Stop the accelerometer
}
...
*
*/
void SenseMeAccelerometerClass::xyz(float buf[3])
{	uint8_t reg[6];
...
*
*/
void SenseMeAccelerometerClass::xyzRaw(uint16_t buf[3])
{	uint8_t reg[6];
...
*
*/
void SenseMeAccelerometerClass::activate()
{	uint8_t reg;
...
*
*/
void SenseMeAccelerometerClass::standby()
{	uint8_t reg;
...
*
*/
void SenseMeAccelerometerClass::writeReg(int firstReg, const uint8_t *buf, uint8_t nRegs)
{
...
*
*/
void SenseMeAccelerometerClass::readReg(int firstReg, uint8_t *buf, uint8_t nRegs)
{
 ...
 */ 
SenseMeAccelerometerClass SenseMeAccelerometer = SenseMeAccelerometerClass();
